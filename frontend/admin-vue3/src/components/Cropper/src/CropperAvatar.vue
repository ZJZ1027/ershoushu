<template>
  <div class="user-info-head" @click="open()">
    <a-avatar v-if="sourceValue" :size="120" class="img-circle img-lg">
      <img :src="sourceValue" alt="avatar" />
    </a-avatar>
    <a-avatar v-if="!sourceValue" :size="120" class="img-circle img-lg">
      <img :src="avatar" alt="avatar" />
    </a-avatar>
    <a-button v-if="showBtn" :class="`${prefixCls}-upload-btn`" @click="open()">
...
.#{$prefix-cls} {
  ...
  &-image-mask {
    ...
    opacity: 0;
    transition: opacity var(--bm-dur-enter) var(--bm-ease-out);
