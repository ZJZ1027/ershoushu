<template>
  <div @click.stop>
    ...
    >
          ...
          <div :class="`${prefixCls}-toolbar`">
            ...
            >
              <template #upload-button>
                <a-tooltip :content="t('cropper.selectImage')" position="bottom">
                  <XButton preIcon="ant-design:upload-outlined" type="primary" />
                </a-tooltip>
              </template>
            </a-upload>
            <a-space>
              <a-tooltip :content="t('cropper.btn_reset')" position="bottom">
                <XButton
                  :disabled="!src"
              ...
              <a-tooltip :content="t('cropper.btn_rotate_left')" position="bottom">
                <XButton
                  :disabled="!src"
              ...
              <a-tooltip :content="t('cropper.btn_rotate_right')" position="bottom">
                <XButton
                  :disabled="!src"
              ...
              <a-tooltip :content="t('cropper.btn_scale_x')" position="bottom">
                <XButton
                  :disabled="!src"
              ...
              <a-tooltip :content="t('cropper.btn_scale_y')" position="bottom">
                <XButton
                  :disabled="!src"
              ...
              <a-tooltip :content="t('cropper.btn_zoom_in')" position="bottom">
                <XButton
                  :disabled="!src"
              ...
              <a-tooltip :content="t('cropper.btn_zoom_out')" position="bottom">
                <XButton
                  :disabled="!src"
      ...
      <template #footer>
        <a-button type="primary" @click="handleOk">{{ t('cropper.okText') }}</a-button>
      </template>
    </Dialog>
  </div>
</template>
