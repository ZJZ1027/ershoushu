...
/**
 * 表格列的时间 Formatter，把单元格值格式化成 YYYY-MM-DD HH:mm:ss
 *
 * @param row 行数据
 * @param column 字段
 * @param cellValue 字段值
...
/**
 * 表格列的时间 Formatter，把单元格值格式化成 YYYY-MM-DD
 *
 * @param row 行数据
 * @param column 字段
 * @param cellValue 字段值
 */
export function dateFormatter2(_row: any, _column: any, cellValue: any): string {
