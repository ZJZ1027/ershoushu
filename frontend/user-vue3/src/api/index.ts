...
export const getBookSuggestIndex = () => http.get('/book/suggest-index')
export const getBook = (id: number) => http.get('/book/get', { params: { id } })
export const getSeller = (sellerId: number) => http.get('/seller/get', { params: { sellerId } })
export const toggleFollow = (userId: number) => http.post('/follow/toggle', null, { params: { userId } })
export const getFollowers = (params: any) => http.get('/follow/followers', { params })
export const getFollowing = (params: any) => http.get('/follow/following', { params })
